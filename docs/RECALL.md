...
- **Folder consolidation:** Single canonical copy at **developer/Decimator-Android**; redundant `~/Decimator-Android` removed. See [docs/FOLDER_STRUCTURE.md](FOLDER_STRUCTURE.md).
